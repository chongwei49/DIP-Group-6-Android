...
INSERT INTO `traits` (`quizCategory`, `personalityType`, `traitName`, `description`) VALUES 
		...
		('16Personalitties', 'ENPJ', 'Diva', 'Glamorous is your middle name. You like it whenever all the eyes in the room are on you.'),
		('16Personalitties', 'EOPJ', 'Councillor', 'You abide by the rules. Playing it safe is the way.'),
		('16Personalitties', 'ENTF', 'Hustler', 'You are the \"If there\'s a will, there\'s a way\" type of person. Street smart.'),
		('16Personalitties', 'EOTF', 'Main Character', 'You do what you want no matter what it is. You like to meddle in a lot of things.'),
		('16Personalitties', 'ENPF', 'Crusader', 'You are an advocate of the law and a righteous person.'),
		('16Personalitties', 'EOPF', 'Perfectionist', 'You are meticulous. You get disappointed when the little things are not going your wat.'),
		...
		('16Personalitties', 'INPJ', 'Maestro', 'You want to be the best in the things you do. You are proud of your skills and may get too competitive sometimes.'),
		('16Personalitties', 'IOPJ', 'Artist', 'You tend to appreciate everything around you. You are also very creative and will use creativity in your daily life.'),
		('16Personalitties', 'INTF', 'Boss', 'You like having authority in all situations. Losing authority might lead to losing confidence.'),
		('16Personalitties', 'IOTF', 'Administrator', 'You like managing things. Your thinking is very mature and tend to be the \"parents\" of the group'),
		('16Personalitties', 'INPF', 'Champion', 'You are very competitive. Losing is never an option.'),
		('16Personalitties', 'IOPF', 'Arbitrator', 'You are very independent. You are the mediator among your peers.'),
