...
INSERT INTO traits (`quizCategory`, `personalityType`, `traitName`, `description`) VALUES
			('16Personalitties', 'ENTJ', 'Entertainer', 'You never fail to make people around you happy. Being fun is so natural for you.'),
			('16Personalitties', 'EOTJ', 'Leader', 'You always set high standards for yourself and people tend to look up to you.'),
			('16Personalitties', 'ENFJ', 'Diva', 'Glamorous is your middle name. You like it whenever all the eyes in the room are on you.'),
			('16Personalitties', 'EOFJ', 'Councillor', 'You abide by the rules. Playing it safe is the way.'),
			('16Personalitties', 'ENTP', 'Hustler', 'You are the "If there\'s a will, there\'s a way" type of person. Street smart.'),
			('16Personalitties', 'EOTP', 'Main Character', 'You do what you want no matter what it is. You like to meddle in a lot of things.'),
			('16Personalitties', 'ENFP', 'Crusader', 'You are an advocate of the law and a righteous person.'),
			('16Personalitties', 'EOFP', 'Perfectionist', 'You are meticulous. You get disappointed when the little things are not going your wat.'),
			('16Personalitties', 'INTJ', 'Architect', 'You like everything planned out. You would rather not improvise.'),
			('16Personalitties', 'IOTJ', 'Scholar', 'Knowledge is power for you. You like learning new skills, hobbies and etc.'),
			('16Personalitties', 'INFJ', 'Maestro', 'You want to be the best in the things you do. You are proud of your skills and may get too competitive sometimes.'),
			('16Personalitties', 'IOFJ', 'Artist', 'You tend to appreciate everything around you. You are also very creative and will use creativity in your daily life.'),
			('16Personalitties', 'INTP', 'Boss', 'You like having authority in all situations. Losing authority might lead to losing confidence.'),
			('16Personalitties', 'IOTP', 'Administrator', 'You like managing things. Your thinking is very mature and tend to be the "parents" of the group'),
			('16Personalitties', 'INFP', 'Champion', 'You are very competitive. Losing is never an option.'),
			('16Personalitties', 'IOFP', 'Arbitrator', 'You are very independent. You are the mediator among your peers.'),
